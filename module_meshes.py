...
## CC
  ("extra_long_button", 0, "extra_long_button", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("longer_button", 0, "longer_button", 0, 0, 0, 0, 0, 0, 0.4, 0.5, 0.5),
  
  ("options_window", 0, "options_window", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("message_window", render_order_plus_1, "message_window", 0, 0, 0, 0, 0, 0, 0.8, 0.5, 0.5),
  ("note_window", 0, "note_window", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  
  ("drop_button", 0, "button_drop", 0, 0, 0, 0, 0, 0, 1, 0.75, 0.5),
  ("drop_button_down", 0, "button_drop_clicked", 0, 0, 0, 0, 0, 0, 1, 0.75, 0.5),
  ("drop_button_hl", 0, "button_drop_hl", 0, 0, 0, 0, 0, 0, 1, 0.75, 0.5),
  ("drop_button_child", 0, "button_drop_child", 0, 0, 0, 0, 0, 0, 1.0, 0.75, 0.5),
  ("drop_button_child_down", 0, "button_drop_child_clicked", 0, 0, 0, 0, 0, 0, 1.0, 0.75, 0.5),
  ("drop_button_child_hl", 0, "button_drop_child_hl", 0, 0, 0, 0, 0, 0, 1.0, 0.75, 0.5),
  ...
  ("double_windows", 0, "mp_ui_profile", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("tri_windows", 0, "tri_windows", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("inventory_window_single", 0, "window_2", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("window_hinge", 0, "window_hinge", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("middle_window_small", 0, "window_8", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("character_creation_window_with_handle", 0, "window_1", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("character_creation_window", 0, "window_9", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("old_background", 0, "old_bg2", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("option_window_new", 0, "window_4", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("mp_ui_background", 0, "window_10", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("warband_logo", 0, "warrider_logo", -0.01, 0.65, 0, 0, 0, 0, 0.8, 0.8, 0.8),
  
  ("new_pic_arms_swadian", 0, "pic_arms_swadian", 0.5, 0.3, 0, 0, 0, 0, 1, 1, 1),
  ("new_pic_arms_vaegir", 0, "pic_arms_vaegir", 0.5, 0.3, 0, 0, 0, 0, 1, 1, 1),
  ("new_pic_arms_khergit", 0, "pic_arms_khergit", 0.5, 0.3, 0, 0, 0, 0, 1, 1, 1),
  ("new_pic_arms_nord", 0, "pic_arms_nord", 0.5, 0.3, 0, 0, 0, 0, 1, 1, 1),
  ("new_pic_arms_rhodok", 0, "pic_arms_rhodok", 0.5, 0.3, 0, 0, 0, 0, 1, 1, 1),
  ("new_pic_sarranid_arms", 0, "pic_sarranid_arms", 0.5, 0.3, 0, 0, 0, 0, 1, 1, 1),
  ("new_pic_mb_warrior_2", 0, "pic_mb_warrior_2", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("new_pic_mb_warrior_3", 0, "pic_mb_warrior_3", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("new_pic_mb_warrior_4", 0, "pic_mb_warrior_4", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("new_pic_mb_warrior_5", 0, "pic_mercenary", 0.6, 0, 0, 0, 0, 0, 1, 1, 1),
