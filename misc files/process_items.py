...
def write_items(variable_list,variable_uses,tag_uses,quick_strings):
  ...
  for item in items:
    ...
    if (item_type == itp_type_arrows or item_type == itp_type_bolts or item_type == itp_type_thrown or item_type == itp_type_bullets):
      trigger_list += missile_distance_trigger
