...
# sf_base_att_vit  = 0x003 ## skill overhaul
...
## skill overhaul
skl_speechcraft          = 0    # skl_trade                = 0
skl_leadership           = 1    # skl_leadership           = 1
skl_prisoner_management  = 2    # skl_prisoner_management  = 2
skl_tenacity             = 3    # skl_reserved_1           = 3
skl_encouragement        = 4    # skl_reserved_2           = 4
skl_tactics              = 5    # skl_reserved_3           = 5
skl_trainer              = 6    # skl_reserved_4           = 6
skl_trade                = 7    # skl_persuasion           = 7
skl_engineer             = 8    # skl_engineer             = 8
skl_first_aid            = 9    # skl_first_aid            = 9
skl_surgery              = 10   # skl_surgery              = 10
skl_wound_treatment      = 11   # skl_wound_treatment      = 11
skl_inventory_management = 12   # skl_inventory_management = 12
skl_spotting             = 13   # skl_spotting             = 13
skl_reserved_1           = 14   # skl_pathfinding          = 14
skl_pathfinding          = 15   # skl_tactics              = 15
skl_tracking             = 16   # skl_tracking             = 16
skl_reserved_2           = 17   # skl_trainer              = 17
skl_cooking              = 18   # skl_reserved_5           = 18
skl_reserved_6           = 19   # skl_reserved_6           = 19
skl_reserved_7           = 20   # skl_reserved_7           = 20
skl_reserved_8           = 21   # skl_reserved_8           = 21
skl_precise_shot         = 22   # skl_looting              = 22
skl_horse_archery        = 23   # skl_horse_archery        = 23
skl_riding               = 24   # skl_riding               = 24
skl_athletics            = 25   # skl_athletics            = 25
skl_shield               = 26   # skl_shield               = 26
skl_weapon_master        = 27   # skl_weapon_master        = 27
skl_reserved_9           = 28   # skl_reserved_9           = 28
skl_looting              = 29   # skl_reserved_10          = 29
skl_power_one_handed     = 30   # skl_reserved_11          = 30
skl_power_two_handed     = 31   # skl_reserved_12          = 31
skl_power_polearm        = 32   # skl_reserved_13          = 32
skl_power_draw           = 33   # skl_power_draw           = 33
skl_power_throw          = 34   # skl_power_throw          = 34
skl_power_strike         = 35   # skl_power_strike         = 35
skl_ironflesh            = 36   # skl_ironflesh            = 36
skl_physique             = 37   # skl_reserved_14          = 37
skl_reserved_15          = 38   # skl_reserved_15          = 38
skl_reserved_16          = 39   # skl_reserved_16          = 39
skl_reserved_17          = 40   # skl_reserved_17          = 40
skl_reserved_18          = 41   # skl_reserved_18          = 41
## skill overhaul
...
knows_cooking_1               = 0x01 << (skl_cooking << 2)
knows_cooking_2               = 0x02 << (skl_cooking << 2)
knows_cooking_3               = 0x03 << (skl_cooking << 2)
knows_cooking_4               = 0x04 << (skl_cooking << 2)
knows_cooking_5               = 0x05 << (skl_cooking << 2)
knows_cooking_6               = 0x06 << (skl_cooking << 2)
knows_cooking_7               = 0x07 << (skl_cooking << 2)
knows_cooking_8               = 0x08 << (skl_cooking << 2)
knows_cooking_9               = 0x09 << (skl_cooking << 2)
knows_cooking_10              = 0x0A << (skl_cooking << 2)
knows_cooking_11              = 0x0B << (skl_cooking << 2)
knows_cooking_12              = 0x0C << (skl_cooking << 2)
knows_cooking_13              = 0x0D << (skl_cooking << 2)
knows_cooking_14              = 0x0E << (skl_cooking << 2)
knows_cooking_15              = 0x0F << (skl_cooking << 2)
...
knows_speechcraft_1           = 0x01 << (skl_speechcraft << 2)
knows_speechcraft_2           = 0x02 << (skl_speechcraft << 2)
knows_speechcraft_3           = 0x03 << (skl_speechcraft << 2)
knows_speechcraft_4           = 0x04 << (skl_speechcraft << 2)
knows_speechcraft_5           = 0x05 << (skl_speechcraft << 2)
knows_speechcraft_6           = 0x06 << (skl_speechcraft << 2)
knows_speechcraft_7           = 0x07 << (skl_speechcraft << 2)
knows_speechcraft_8           = 0x08 << (skl_speechcraft << 2)
knows_speechcraft_9           = 0x09 << (skl_speechcraft << 2)
knows_speechcraft_10          = 0x0A << (skl_speechcraft << 2)
knows_speechcraft_11          = 0x0B << (skl_speechcraft << 2)
knows_speechcraft_12          = 0x0C << (skl_speechcraft << 2)
knows_speechcraft_13          = 0x0D << (skl_speechcraft << 2)
knows_speechcraft_14          = 0x0E << (skl_speechcraft << 2)
knows_speechcraft_15          = 0x0F << (skl_speechcraft << 2)
...
knows_encouragement_1         = 0x01 << (skl_encouragement << 2)
knows_encouragement_2         = 0x02 << (skl_encouragement << 2)
knows_encouragement_3         = 0x03 << (skl_encouragement << 2)
knows_encouragement_4         = 0x04 << (skl_encouragement << 2)
knows_encouragement_5         = 0x05 << (skl_encouragement << 2)
knows_encouragement_6         = 0x06 << (skl_encouragement << 2)
knows_encouragement_7         = 0x07 << (skl_encouragement << 2)
knows_encouragement_8         = 0x08 << (skl_encouragement << 2)
knows_encouragement_9         = 0x09 << (skl_encouragement << 2)
knows_encouragement_10        = 0x0A << (skl_encouragement << 2)
knows_encouragement_11        = 0x0B << (skl_encouragement << 2)
knows_encouragement_12        = 0x0C << (skl_encouragement << 2)
knows_encouragement_13        = 0x0D << (skl_encouragement << 2)
knows_encouragement_14        = 0x0E << (skl_encouragement << 2)
knows_encouragement_15        = 0x0F << (skl_encouragement << 2)
knows_one_handed_1            = 0x01 << (skl_power_one_handed << 2)
knows_one_handed_2            = 0x02 << (skl_power_one_handed << 2)
knows_one_handed_3            = 0x03 << (skl_power_one_handed << 2)
knows_one_handed_4            = 0x04 << (skl_power_one_handed << 2)
knows_one_handed_5            = 0x05 << (skl_power_one_handed << 2)
knows_one_handed_6            = 0x06 << (skl_power_one_handed << 2)
knows_one_handed_7            = 0x07 << (skl_power_one_handed << 2)
knows_one_handed_8            = 0x08 << (skl_power_one_handed << 2)
knows_one_handed_9            = 0x09 << (skl_power_one_handed << 2)
knows_one_handed_10           = 0x0A << (skl_power_one_handed << 2)
knows_one_handed_11           = 0x0B << (skl_power_one_handed << 2)
knows_one_handed_12           = 0x0C << (skl_power_one_handed << 2)
knows_one_handed_13           = 0x0D << (skl_power_one_handed << 2)
knows_one_handed_14           = 0x0E << (skl_power_one_handed << 2)
knows_one_handed_15           = 0x0F << (skl_power_one_handed << 2)
knows_two_handed_1            = 0x01 << (skl_power_two_handed << 2)
knows_two_handed_2            = 0x02 << (skl_power_two_handed << 2)
knows_two_handed_3            = 0x03 << (skl_power_two_handed << 2)
knows_two_handed_4            = 0x04 << (skl_power_two_handed << 2)
knows_two_handed_5            = 0x05 << (skl_power_two_handed << 2)
knows_two_handed_6            = 0x06 << (skl_power_two_handed << 2)
knows_two_handed_7            = 0x07 << (skl_power_two_handed << 2)
knows_two_handed_8            = 0x08 << (skl_power_two_handed << 2)
knows_two_handed_9            = 0x09 << (skl_power_two_handed << 2)
knows_two_handed_10           = 0x0A << (skl_power_two_handed << 2)
knows_two_handed_11           = 0x0B << (skl_power_two_handed << 2)
knows_two_handed_12           = 0x0C << (skl_power_two_handed << 2)
knows_two_handed_13           = 0x0D << (skl_power_two_handed << 2)
knows_two_handed_14           = 0x0E << (skl_power_two_handed << 2)
knows_two_handed_15           = 0x0F << (skl_power_two_handed << 2)
knows_polearm_1               = 0x01 << (skl_power_polearm << 2)
knows_polearm_2               = 0x02 << (skl_power_polearm << 2)
knows_polearm_3               = 0x03 << (skl_power_polearm << 2)
knows_polearm_4               = 0x04 << (skl_power_polearm << 2)
knows_polearm_5               = 0x05 << (skl_power_polearm << 2)
knows_polearm_6               = 0x06 << (skl_power_polearm << 2)
knows_polearm_7               = 0x07 << (skl_power_polearm << 2)
knows_polearm_8               = 0x08 << (skl_power_polearm << 2)
knows_polearm_9               = 0x09 << (skl_power_polearm << 2)
knows_polearm_10              = 0x0A << (skl_power_polearm << 2)
knows_polearm_11              = 0x0B << (skl_power_polearm << 2)
knows_polearm_12              = 0x0C << (skl_power_polearm << 2)
knows_polearm_13              = 0x0D << (skl_power_polearm << 2)
knows_polearm_14              = 0x0E << (skl_power_polearm << 2)
knows_polearm_15              = 0x0F << (skl_power_polearm << 2)
