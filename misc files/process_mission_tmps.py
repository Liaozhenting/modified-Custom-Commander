...
def save_mission_templates(variables,variable_uses,tag_uses,quick_strings):
  ...
  for mission_template in mission_templates:
    ...
    ## skill overhaul
    save_triggers(file,convert_to_identifier(mission_template[mission_template_name_pos]), mission_template[mission_template_triggers_pos]+skill_overhaul_triggers,variables,variable_uses,tag_uses,quick_strings)
    ## skill overhaul
    file.write("\n")
  file.close()
