...
skill_overhaul_damage_modifier =(
  1, 0, 0, [],
    [
      (try_for_agents, ":agent_no"),
        ...
        (try_begin),
          ...
          (try_begin), 
            ...
            # accuracy_modifier
            # (store_mul, ":accuracy_modifier", ":precise_shot_level", 2),
            # (val_add, ":accuracy_modifier", 100),
          (try_end),
          ## lords dealer 2X damage
          (try_begin),
            (troop_is_hero, ":troop_no"),
            (gt, ":agent_party", "p_main_party"),
            (val_mul, ":damage_modifier", 2),
            (val_mul, ":ranged_damage_modifier", 2),
          (try_end),
          # ## skl_encouragement, increase damage by 3% per level
          # (try_begin),
            # (gt, ":agent_party", -1),
            # (party_stack_get_troop_id, ":party_leader", ":agent_party", 0),
            # (troop_is_hero, ":party_leader"),
            # #(neq, ":troop_no", ":party_leader"),
            # (store_skill_level, ":encouragement_level", "skl_encouragement", ":party_leader"),
            # (val_mul, ":encouragement_level", 3),
            # (val_add, ":encouragement_level", 100),
            # # damage_modifier
            # (val_mul, ":damage_modifier", ":encouragement_level"),
            # (val_div, ":damage_modifier", 100),
            # # ranged_damage_modifier
            # (val_mul, ":ranged_damage_modifier", ":encouragement_level"),
            # (val_div, ":ranged_damage_modifier", 100),
          # (try_end),
        (try_end),
        (agent_set_damage_modifier, ":agent_no", ":damage_modifier"), 
        (agent_set_ranged_damage_modifier, ":agent_no", ":ranged_damage_modifier"), 
        #(agent_set_accuracy_modifier, ":agent_no", ":accuracy_modifier"), 
        # DEBUG message
        # (try_begin),
          # (eq, "$cheat_mode", 1),
          # (get_player_agent_no, ":player_agent"),
          # (eq, ":agent_no", ":player_agent"),
          # (assign, reg4, ":damage_modifier"),
          # (assign, reg5, ":ranged_damage_modifier"),
          # (display_message, "@{!}DEBUG -- damage_modifier = {reg4}, ranged_damage_modifier = {reg5}"),
        # (try_end),
      (try_end),
    ])
   
skill_overhaul_reduce_damage = (
  ti_on_agent_hit, 0, 0, [],
    [
      (store_trigger_param, ":inflicted_agent", 1),
      ...
      (try_begin),
        ...
        (try_begin), # is a horse, get rider
          (neg|agent_is_human, ":inflicted_agent"), 
          (agent_get_rider, ":human_agent", ":inflicted_agent"),
        (else_try), # is a human
          #(agent_is_human, ":inflicted_agent"), 
          (assign, ":human_agent", ":inflicted_agent"),
        (try_end),
        (try_begin),
          (gt, ":human_agent", -1),
          (agent_get_troop_id, ":human_troop_no", ":human_agent"),
          (agent_get_horse, ":horse_agent", ":human_agent"),
          (try_begin), # has horse
            (gt, ":horse_agent", -1),
            (store_skill_level, ":skill_level", "skl_riding", ":human_troop_no"),
          (else_try), # has no horse
            (store_skill_level, ":skill_level", "skl_athletics", ":human_troop_no"),
          (try_end),
          (store_mul, ":damage_ratio", ":skill_level", -4),
          (val_add, ":damage_ratio", 100),
          (val_mul, ":dest_damage", ":damage_ratio"),
          ...
          (try_end),
        (try_end),
        # skl_ironflesh reduce 1 damage per level
        (try_begin),
          (agent_is_human, ":inflicted_agent"),
  ...
  # ti_on_agent_hit, 0, 0, [],
    # [
      ...
      # (try_begin),
        ...
        # # human's skl_ironflesh and ca_vitality
        # (try_begin),
          # (agent_is_human, ":inflicted_agent"),
          # # ## skl_tenacity, reduce damage by 3% per level
          # # (agent_get_party_id, ":agent_party", ":inflicted_agent"),
          # # (try_begin),
            # # (gt, ":agent_party", -1),
            # # (party_stack_get_troop_id, ":party_leader", ":agent_party", 0),
            # # (troop_is_hero, ":party_leader"),
            # # #(neq, ":inflicted_troop", ":party_leader"),
          ...
          # # skl_ironflesh reduce damage by 4% per level
          # (store_skill_level, ":ironflesh_level", "skl_ironflesh", ":inflicted_troop"),
          # (store_mul, ":reduced_damage", ":ironflesh_level", 4),
          # (val_mul, ":reduced_damage", ":dest_damage"),
          ...
          # # (try_begin),
            ...
            # # (assign, reg4, ":reduced_damage"),
            # # (assign, reg5, ":inflicted_damage"),
            # # (assign, reg6, ":ironflesh_level"),
            # # (display_message, "@{!}DEBUG -- reduced_damage = {reg4}, inflicted_damage = {reg5}, ironflesh_level = {reg6}"),
          # # (try_end),
          
          # # # ca_vitality reduce damage by 1% per point
          # # (store_attribute_level, ":vitality", ":inflicted_troop", ca_vitality),
          # # (val_min, ":vitality", 63),
          # # (store_mul, ":reduced_damage_2", ":vitality", 1),
          ...
          # # (try_begin),
            ...
            # # (get_player_agent_no, ":player_agent"),
            # # (eq, ":dealer_agent", ":player_agent"),
            # # (assign, reg4, ":reduced_damage_2"),
            # # (assign, reg5, ":inflicted_damage"),
            # # (assign, reg6, ":vitality"),
            # # (display_message, "@{!}DEBUG -- reduced_damage_2 = {reg4}, inflicted_damage = {reg5}, vitality_level = {reg6}"),
          # # (try_end),
        # (try_end),
        
        # ## lords and their horses get only 1/2 damage
        # (try_begin),
          # (neg|agent_is_human, ":inflicted_agent"), # is a horse
          # (agent_get_rider, ":human_agent", ":inflicted_agent"),
        # (else_try),
          # (assign, ":human_agent", ":inflicted_agent"),
        # (try_end),
...
# skill_overhaul_agent_spawn = (
  ...
  # [
    ...
    # (agent_is_human, ":agent_no"),
    # (agent_get_troop_id, ":troop_no", ":agent_no"),
    # (store_skill_level, ":ironflesh_level", "skl_ironflesh", ":troop_no"),
    # (store_mul, ":speed_modifier", ":ironflesh_level", 3),
    # (val_add, ":speed_modifier", 100),
    # (agent_set_speed_modifier, ":agent_no", ":speed_modifier"),
  # ])
    
skill_overhaul_triggers = [
    skill_overhaul_damage_modifier,
    skill_overhaul_reduce_damage,
    #skill_overhaul_agent_spawn,
   ]
...
custom_commander_camera = (
  ...
  [
    ...
    (mission_cam_set_position, pos1),
    (try_begin),
      (key_clicked, "$g_key_camera_toggle"),
...
custom_commander_toggle_charging = (
  0, 0, 0, [],
   [
    ...
    (agent_get_horse, ":horse_agent", ":player_agent"),
    (ge, ":horse_agent", 0),
    (agent_get_slot, ":horse_stamina", ":horse_agent", slot_agent_horse_stamina),
    (store_agent_hit_points, ":horse_hp", ":horse_agent"),
    (val_min, ":horse_stamina", ":horse_hp"),
    (agent_set_slot, ":horse_agent", slot_agent_horse_stamina, ":horse_stamina"),
    (key_clicked, key_left_alt),
    (try_begin),
      (agent_slot_eq, ":horse_agent", slot_agent_horse_is_charging, 1),
      (agent_set_slot, ":horse_agent", slot_agent_horse_is_charging, 0),
    (else_try),
      (agent_slot_eq, ":horse_agent", slot_agent_horse_is_charging, 0),
      (ge, ":horse_stamina", 12),
      (agent_set_slot, ":horse_agent", slot_agent_horse_is_charging, 1),
    (try_end),
   ])
...
custom_commander_horse_speed = (
  ...
  (store_mod, ":timer_mod_value", ":mission_timer", 6),
  
  (try_for_agents, ":horse_agent"),
    (agent_is_alive, ":horse_agent"),
    (neg|agent_is_human, ":horse_agent"), # is a horse
    (agent_get_rider, ":rider_agent", ":horse_agent"),
    ...
    (try_begin),
      (le, ":rider_agent", -1), # no rider
      (agent_set_slot, ":horse_agent", slot_agent_horse_is_charging, 0),
    (else_try),
      #(gt, ":rider_agent", -1),
      (neq, ":rider_agent", ":player_agent"),
    ...
    (else_try),
      (agent_slot_eq, ":horse_agent", slot_agent_horse_is_charging, 1),
      (agent_get_troop_id, ":rider_troop", ":rider_agent"),
      (store_skill_level, ":skl_level", skl_riding, ":rider_troop"),
      (store_add, ":speed_multi", ":skl_level", 5),
      (val_mul, ":speed_multi", ":speed_multi"),
      (val_div, ":speed_multi", 4),
      (val_sub, ":horse_stamina", 12),
    ...
    (try_begin),
      (gt, ":rider_agent", -1),
      # horse_hp_affect_horse_speed
      (store_sub, ":lost_hp", 100, ":horse_hp"),
      (try_begin),
        (eq, "$g_horse_hp_affect_horse_speed", 0),
      ...
      (agent_set_horse_speed_factor, ":rider_agent", ":speed_factor"),
      
      # horse archer
      (try_begin),
        (neq, ":rider_agent", ":player_agent"),
        (agent_get_wielded_item, ":cur_weapon", ":rider_agent", 0),
        (gt, ":cur_weapon", -1),
        ...
        (agent_get_attack_action, ":attack_action", ":rider_agent"),
        (agent_ai_get_look_target, ":target_agent", ":rider_agent"),
        (try_begin),
          (gt, ":target_agent", -1),
          (agent_is_alive, ":target_agent"),
          (agent_get_position, pos3, ":rider_agent"),
          (agent_get_position, pos4, ":target_agent"),
          (get_distance_between_positions, ":distance", pos3, pos4),
        (else_try),
          (assign, ":distance", 99999),
        (try_end),
        (try_begin),
          (lt, ":timer_mod_value", 4),
          (is_between, ":distance", 500, 3000),
          (eq, ":attack_action", 1), # readying_attack
          (agent_get_speed_modifier, ":speed_modifier", ":horse_agent"),
          (val_div, ":speed_modifier", 3),
          (agent_set_speed_modifier, ":horse_agent", ":speed_modifier"),
          (agent_set_horse_speed_factor, ":rider_agent", ":speed_modifier"),
          (agent_set_slot, ":horse_agent", slot_agent_horse_is_charging, 0),
        (else_try),
          (agent_set_speed_modifier, ":horse_agent", 100),
          (agent_set_horse_speed_factor, ":rider_agent", 100),
        (try_end),
      (try_end),
      # horse archer
    (try_end),
...
custom_commander_fill_agent_empty_wpn_slot = (
  3, 0, 0, [],
  [
    # add ammo if needed for range wpn 
    (try_for_agents, ":agent_no"),
      (agent_slot_eq, ":agent_no", slot_agent_is_checked_for_ammo, 0),
      (agent_set_slot, ":agent_no", slot_agent_is_checked_for_ammo, 1),
      (agent_is_alive, ":agent_no"),
      (agent_is_human, ":agent_no"),
      (agent_get_troop_id, ":troop_no", ":agent_no"),
      (neg|troop_is_hero, ":troop_no"),
      ...
      (try_for_range, ":cur_slot", 0, 4),
        ...
        (else_try),
          (gt, ":cur_weapon", 0),
          (item_get_type, ":i_type", ":cur_weapon"),
          (this_or_next|eq, ":i_type", itp_type_arrows),
          (this_or_next|eq, ":i_type", itp_type_bolts),
          #(this_or_next|eq, ":i_type", itp_type_thrown),
          (eq, ":i_type", itp_type_bullets),
          (assign, ":ammo_type", ":i_type"),
        (try_end),
      (try_end),
      # has range weapon
      (gt, ":ammo_type", -1),
      (try_begin), 
        # is an archer, remove second_meele_wpn or shield
        (eq, ":ammo_type", itp_type_arrows), 
        # find the first meele_wpn slot
        (assign, ":first_meele_wpn_slot", -1),
        (assign, ":end_cond", 4),
        (try_for_range, ":cur_slot", 0, ":end_cond"),
          (agent_get_item_slot, ":cur_weapon", ":agent_no", ":cur_slot"),
          (gt, ":cur_weapon", 0),
          (item_get_type, ":i_type", ":cur_weapon"),
          (this_or_next|eq, ":i_type", itp_type_one_handed_wpn),
          (eq, ":i_type", itp_type_two_handed_wpn),
          (assign, ":first_meele_wpn_slot", ":cur_slot"),
          (assign, ":end_cond", 0), # break
        (try_end),
        # find the second meele_wpn and remove
        (gt, ":first_meele_wpn_slot", -1),
        (assign, ":end_cond", 4),
        (try_for_range, ":cur_slot", 0, ":end_cond"),
          (neq, ":cur_slot", ":first_meele_wpn_slot"),
          (agent_get_item_slot, ":cur_weapon", ":agent_no", ":cur_slot"),
          (gt, ":cur_weapon", 0),
          (item_get_type, ":i_type", ":cur_weapon"),
          (this_or_next|eq, ":i_type", itp_type_one_handed_wpn),
          (this_or_next|eq, ":i_type", itp_type_two_handed_wpn),
          (this_or_next|eq, ":i_type", itp_type_polearm),
      ...
      (try_for_range, ":i_slot", 10, ":end_cond"),
        ...
        (eq, ":type", ":ammo_type"),
        (troop_get_inventory_slot_modifier, ":item_modifier", ":troop_no", ":i_slot"),
        (assign, ":end_cond_2", 4),
        (try_for_range, ":cur_slot", 0, ":end_cond_2"),
          (agent_get_item_slot, ":cur_weapon", ":agent_no", ":cur_slot"),
          (eq, ":cur_weapon", -1),
          (agent_equip_item, ":agent_no", ":item", ":cur_slot", ":item_modifier"),
          (val_sub, ":empty_slots", 1),
          (assign, ":end_cond_2", 0),
        (try_end),
        (eq, ":empty_slots", 0),
        (assign, ":end_cond", 0), # break
      ...
      # (agent_get_ammo, ":agent_ammo", ":agent_no"),
      # (assign, reg1, ":agent_ammo"),
      # (display_message, "@{s1}: {reg1}.", 0xCCCCCC),
    (try_end),
  ])
...
custom_commander_main_hero_fallen_info = (
  1, 0, 15, [(main_hero_fallen)],
    ...
    (try_for_range, ":class_no", 0, 9),
      (team_give_order, ":player_team", ":class_no", mordr_charge),
    (try_end),
    (set_show_messages, 1),
   ])
    
# # Register 0: damage dealer item_id
# custom_commander_damage_modifier =(
  # ti_on_agent_hit, 0, 0, [],
    # [
      ...
      # # display shot_distance
      # # (try_begin),
        # # (eq, "$g_report_shot_distance", 1),
        # # (eq, ":dealer_agent", ":player_agent"), # player
        # # (gt, ":dealer_item_id", -1),
        # # (item_get_type, ":item_type", ":dealer_item_id"), # ranged weapons
        # # (this_or_next|eq, ":item_type", itp_type_bow),
        ...
        # # (agent_is_human, ":inflicted_agent"),
        # # (neg|agent_is_ally, ":inflicted_agent"),
      ...
      # (try_begin),
        ...
        # (try_begin),
          ...
          # (neq, ":dealer_troop", "trp_player"),
          # (neq, ":dealer_troop", "$g_player_troop"),
          # (agent_get_party_id, ":agent_party", ":dealer_agent"),
          # (gt, ":agent_party", "p_main_party"),
          # (val_mul, ":dest_damage", 2),
        # (try_end),
        
        # ## skl_precise_shot: +6% ranged damage per level
        # (try_begin),
          # (item_get_type, ":item_type", ":dealer_item_id"), # ranged weapons, excludes throwing weapons
          # (this_or_next|eq, ":item_type", itp_type_bow),
          # (this_or_next|eq, ":item_type", itp_type_crossbow),
          # #(this_or_next|eq, ":item_type", itp_type_thrown),
          # (this_or_next|eq, ":item_type", itp_type_pistol),
          # (eq, ":item_type", itp_type_musket),
          # (store_skill_level, ":precise_shot_level", "skl_precise_shot", ":dealer_troop"),
          # (store_mul, ":damage_modifier", ":precise_shot_level", 6),
          # (val_add, ":damage_modifier", 100),
          # (val_mul, ":dest_damage", ":damage_modifier"),
          # (val_div, ":dest_damage", 100),
          # # # DEBUG message
          # # (try_begin),
            # # (eq, "$cheat_mode", 1),
            ...
            # # (assign, reg5, ":inflicted_damage"),
            # # (assign, reg6, ":precise_shot_level"),
            # # (display_message, "@{!}DEBUG -- dest_damage = {reg4}, inflicted_damage = {reg5}, precise_shot_level = {reg6}"),
          # # (try_end),
        # (try_end),
        
        # (try_begin),
          # ## lord's horse gets only 1/2 damage
          # (neg|agent_is_human, ":inflicted_agent"), # is a horse
          # (agent_get_rider, ":rider_agent", ":inflicted_agent"),
          # (try_begin),
            # (gt, ":rider_agent", -1),
            # (agent_get_troop_id, ":rider_troop_no", ":rider_agent"),
            # (troop_is_hero, ":rider_troop_no"),
            # (neq, ":rider_troop_no", "trp_player"),
            # (neq, ":rider_troop_no", "$g_player_troop"),
            # (agent_get_party_id, ":rider_agent_party", ":rider_agent"),
            # (gt, ":rider_agent_party", "p_main_party"),
            # (val_div, ":dest_damage", 2),
          # (try_end),
        # (else_try),
          # (agent_is_human, ":inflicted_agent"),
          # ## lords get only 1/2 damage
          # (agent_get_troop_id, ":inflicted_troop", ":inflicted_agent"),
          # (try_begin),
...
# custom_commander_agent_init_skl_level = (
  # ti_on_agent_spawn, 0, 0, [],
  # [
    # (store_trigger_param_1, ":agent_no"),
    # (agent_get_troop_id, ":troop_no", ":agent_no"),
    # (store_skill_level, ":ironflesh_level", skl_ironflesh, ":troop_no"),
    # (store_skill_level, ":dodge_level", skl_dodge, ":troop_no"),
    # (agent_set_slot, ":agent_no", slot_agent_ironflesh_level, ":ironflesh_level"),
    # (agent_set_slot, ":agent_no", slot_agent_dodge_level, ":dodge_level"),
  # ])
...
# custom_commander_battlefield_size = (
  # 0, 0, ti_once, [],
    # [
    # (get_scene_boundaries, pos10,pos11),
    # (position_get_x, reg3, pos10),
    # (position_get_y, reg4, pos10),
    # (position_get_x, reg5, pos11),
    # (position_get_y, reg6, pos11),
...
common_siege_defender_reinforcement_check = (
  ...
  [
    ...
    # (this_or_next|lt, "$defender_reinforcement_stage", 10),
    ...
    (else_try),
      ...
      (call_script, "script_get_num_defenders_left", 0),
      (assign, ":num_enemy_left", reg0),
      (try_begin),
        (party_slot_eq, "$g_encountered_party", slot_party_type, spt_town),
        (assign, ":num_reserved_enemy", 38),
      (else_try),
        (party_slot_eq, "$g_encountered_party", slot_party_type, spt_castle),
        (assign, ":num_reserved_enemy", 10),
      (try_end),
      (store_add, ":num_reserved_enemy_plus_50", ":num_reserved_enemy", 50),
      
      (try_begin),
        (le, ":num_enemy_left", ":num_reserved_enemy"),
      (else_try),
        (this_or_next|lt, "$defender_reinforcement_stage", 10),
        (gt, ":num_enemy_left", ":num_reserved_enemy_plus_50"),
        (store_normalized_team_count, ":num_defenders_normalized", 0),
        (try_begin),
          (lt, ":num_defenders_normalized", 8),
          (add_reinforcements_to_entry, 4, 4),
...
tournament_triggers = [
  ...
  [
     ...
     (assign, ":passed", 0),
     (try_begin),
       (ge, "$g_arena_tournament_kills", 2),
       (assign, ":passed", 1),
     (else_try),
       (eq, "$g_arena_tournament_kills", 1),
  ...
  [
    ...
    (try_begin),
      ...
      (agent_is_human, ":wounded_agent_no"),
      (neg|agent_is_ally, ":wounded_agent_no"),
      (val_add, "$g_arena_tournament_kills", 1),
      (agent_get_troop_id, ":wounded_troop", ":wounded_agent_no"),
      (store_character_level, ":troop_level", ":wounded_troop"),
      (store_add, ":gold_bonus", ":troop_level", 20),
  ...
  (ti_on_agent_dismount, 0, 0, [],
   [
     ...
     (eq, "$g_mt_mode", abm_tournament),
     (agent_get_wielded_item, ":weapon_id", ":agent_no", 0),
     #(eq, ":weapon_id", "itm_practice_lance"),
     (is_between, ":weapon_id", "itm_practice_lance_r", "itm_practice_javelin_r"),
     (agent_unequip_item, ":agent_no", ":weapon_id"),
     (agent_equip_item, ":agent_no", "itm_practice_dagger"),
     (agent_set_wielded_item, ":agent_no", "itm_practice_dagger"),
     ]),
  ## CC
  (ti_tab_pressed, 0, 0, [],
   [(try_begin),
...
##           ]),
  ...
  (0, 0, ti_once, [],
   [
     ...
     (assign, "$g_arena_tournament_kills", 0), ## CC
     ]),
  ...
  (0, 0, ti_once, [], [(eq, "$g_mt_mode", abm_training),
                       ...
                       ## CC
                       (try_begin),
                         (eq, "$g_arena_training_special_mode", 1),
                         (get_player_agent_no, ":player_agent"),
...
#-----------------------------------------------------------------
      ...
      (1, 0, 0, [], 
        [
          ...
          (try_begin),
            (le, ":cur_timer", 8),
            (call_script, "script_tutorial_message_set_format", 17, 17, 400, 650, 0, 1),
            (store_sub, reg0, 8, ":cur_timer"),
            (tutorial_message, "@You can access your inventory by press the I key in {reg0} seconds..."),
          (else_try),
            (tutorial_message, -1),
          (try_end),
        ]),
  ...
  (
    ...
    [
      ...
      (0, 1, ti_once, [], [
        ...
        ## pointer_arrow
        (prop_instance_get_position, pos0, ":player_chest"),
        (set_spawn_position, pos0),
        (spawn_scene_prop, "spr_pointer_arrow"),
        (assign, "$g_pointer_arrow_height_adder", 20),
      ]),
      
      (0, 0, 0,
       [
        (scene_prop_get_instance, ":pointer_arrow", "spr_pointer_arrow", 0),
        (ge, ":pointer_arrow", 0),
         ], 
         [
  ...
  (
    ...
    "You lead your men to battle.",
    [
     (1,mtef_defenders|mtef_team_0,0,aif_start_alarmed,1,[]), ## CC
     (0,mtef_defenders|mtef_team_0,0,aif_start_alarmed,0,[]),
     (4,mtef_attackers|mtef_team_1,0,aif_start_alarmed,1,[]), ## CC
    ...
    [
      (0, 0, ti_once, [], [(assign,"$g_battle_won",0),
                           ...
                           (store_mul, ":num_reinforcements", "$g_battle_size_multiple", 15),
                           (val_div, ":num_reinforcements", 10),
                           (add_reinforcements_to_entry, 0, ":num_reinforcements"),
                           (add_reinforcements_to_entry, 3, ":num_reinforcements"),
                           ## CC
                           (call_script, "script_set_player_banner_and_inventory"),
                           (call_script, "script_combat_music_set_situation_with_culture"),
                           ## CC
                           ...
                           (try_for_range, ":class_no", 0, 9),
                             ...
                             (team_give_order, ":player_team", ":class_no", ":entering_order"),
                             (try_begin),
                               (eq, ":entering_order", mordr_hold),
                               (team_give_order, ":player_team", ":class_no", mordr_advance),
                             (try_end),
                           (try_end),
                           (set_show_messages, 1),
                           ## CC
      ...
      (ti_on_agent_killed_or_wounded, 0, 0, [],
       [
        ...
        ## CC
        (call_script, "script_force_agent_killed_or_wounded", ":dead_agent_no", ":killer_agent_no", ":is_wounded"), 
        (assign, ":is_wounded", reg0),
        # (call_script, "script_give_hero_extra_weapon_points", ":dead_agent_no", ":killer_agent_no"), 
        (try_begin),
          (eq, ":is_wounded", 1),
...
##          (agent_get_team, reg3, ":dead_agent_no"),          
      ...
      (ti_before_mission_start, 0, 0, [],
       [
         (team_set_relation, 0, 2, 1),
         (team_set_relation, 1, 3, 1),
         # (call_script, "script_place_player_banner_near_inventory_bms"), ## CC
      ...
      (lt,"$defender_reinforcement_stage","$g_defender_reinforcement_limit"),
                ...
                (store_mul, ":num_defender_lower_bound", "$g_battle_size_multiple", 6),
                (val_div, ":num_defender_lower_bound", 10),
                (this_or_next|lt,":num_defenders",":num_defender_lower_bound"),
                (lt, ":defenders_mul_3", ":attackers"), # 3 times
                ## CC
                ],
           [
            ## CC
            (store_mul, ":num_reinforcements", "$g_battle_size_multiple", 10),
            (val_div, ":num_reinforcements", 10),
            (add_reinforcements_to_entry,0,":num_reinforcements"),
            ## CC
      ...
      (1, 0, 5, [
                ...
                (store_normalized_team_count,":num_attackers", 1),
                (store_mul, ":num_attackers_lower_bound", "$g_battle_size_multiple", 6),
                (val_div, ":num_attackers_lower_bound", 10),
                (this_or_next|lt,":num_attackers",":num_attackers_lower_bound"),
...
## CC
      ...
      (0, 0, ti_once, [
       ...
       [(call_script, "script_select_battle_tactic"),
        ...
        (call_script, "script_get_double_wings_position"), ## CC
...
## CC
  ...
  (
    ...
    [
     ## CC
     (0, mtef_attackers|mtef_use_exact_number|mtef_team_1,af_override_horse,aif_start_alarmed,20,[]),
...
## CC
  ...
  (
    ...
    [
     ...
     (40,mtef_defenders|mtef_team_0|mtef_archers_first|mtef_use_exact_number,af_override_horse,aif_start_alarmed,4,[]),
     (41,mtef_defenders|mtef_team_0|mtef_archers_first|mtef_use_exact_number,af_override_horse,aif_start_alarmed,4,[]),
     (42,mtef_defenders|mtef_team_0|mtef_archers_first|mtef_use_exact_number,af_override_horse,aif_start_alarmed,4,[]),
     (43,mtef_defenders|mtef_team_0|mtef_archers_first|mtef_use_exact_number,af_override_horse,aif_start_alarmed,4,[]),
     (44,mtef_defenders|mtef_team_0|mtef_archers_first|mtef_use_exact_number,af_override_horse,aif_start_alarmed,4,[]),
     (45,mtef_defenders|mtef_team_0|mtef_archers_first|mtef_use_exact_number,af_override_horse,aif_start_alarmed,4,[]),
     (46,mtef_defenders|mtef_team_0|mtef_archers_first|mtef_use_exact_number,af_override_horse,aif_start_alarmed,4,[]),
     (47,mtef_defenders|mtef_team_0|mtef_archers_first|mtef_use_exact_number,af_override_horse,aif_start_alarmed,4,[]),
     ## CC
     ],
    [
      common_battle_mission_start,
      ...
      (ti_inventory_key_pressed, 0, 0, [], 
        [
          ...
          (try_begin),
            ...
            (this_or_next|eq, ":player_team", "$defender_team"),
            (eq, ":player_team", "$defender_team_2"),
            (display_message, "@Use your baggage to access your inventory during battle. It's at the position of reinforcement."),
          (else_try),
            (le, ":cur_timer", 8),
            (set_trigger_result,1),
          (else_try),
      ...
      common_battle_order_panel,
      common_battle_order_panel_tick,
      #common_inventory_not_available, ## CC
      common_siege_init_ai_and_belfry,
      common_siege_move_belfry,
      common_siege_rotate_belfry,
      common_siege_assign_men_to_belfry,
    ...
    [
      ...
      # (1, 0, 0, [], 
        # [
          ...
          # (get_player_agent_no, ":player_agent"),
          # (try_for_agents, ":cur_agent"), 
            # (agent_slot_eq, ":cur_agent", slot_agent_siege_state_checked, 0),
            # (agent_set_slot, ":cur_agent", slot_agent_siege_state_checked, 1),
            # (neq, ":cur_agent", ":player_agent"),
            # (agent_is_alive, ":cur_agent"),
            # (agent_is_human, ":cur_agent"),
            # (agent_get_team, ":agent_team", ":cur_agent"),
            ...
            # (try_begin),
              ...
              # (try_begin),
                # (ge, "$cur_ladder_to_assign_archers", "$num_ladders"), 
                # (assign, "$cur_ladder_to_assign_archers", 0),
              # (try_end),
            # (else_try),
              # (agent_set_slot, ":cur_agent", slot_agent_target_ladder, "$cur_ladder_to_assign_others"),
              # (val_add, "$cur_ladder_to_assign_others", 1),
              # (try_begin),
                # (ge, "$cur_ladder_to_assign_others", "$num_ladders"), 
                # (assign, "$cur_ladder_to_assign_others", 0),
              # (try_end),
            # (try_end),
          # (try_end),
...
#      (ti_before_mission_start, 0, 0, [], [(set_rain, 1,100)]),
  ...
  (
    ...
    [
      ## CC
      (0,mtef_visitor_source|mtef_team_0,af_override_all,aif_start_alarmed,1,[itm_practice_bow,itm_practice_arrows,itm_practice_arrows_back,itm_practice_horse,itm_arena_tunic_red, itm_red_tourney_helmet]),
      ...
      (4,mtef_visitor_source|mtef_team_0,af_override_all,aif_start_alarmed,1,[itm_practice_bow,itm_practice_arrows,itm_practice_arrows_back, itm_practice_dagger, itm_arena_tunic_red]),
      ...
      (8,mtef_visitor_source|mtef_team_1,af_override_all,aif_start_alarmed,1,[itm_practice_bow,itm_practice_arrows,itm_practice_arrows_back,itm_practice_dagger, itm_arena_tunic_blue]),
      ...
      (12,mtef_visitor_source|mtef_team_1,af_override_all,aif_start_alarmed,1,[itm_practice_bow,itm_practice_arrows,itm_practice_arrows_back,itm_practice_horse,itm_arena_tunic_blue]),
      ...
      (16,mtef_visitor_source|mtef_team_2,af_override_all,aif_start_alarmed,1,[itm_practice_bow,itm_practice_arrows,itm_practice_arrows_back,itm_practice_horse,itm_arena_tunic_green, itm_green_tourney_helmet]),
      ...
      (20,mtef_visitor_source|mtef_team_2,af_override_all,aif_start_alarmed,1,[itm_practice_bow,itm_practice_arrows,itm_practice_arrows_back,itm_practice_dagger, itm_arena_tunic_green, itm_green_tourney_helmet]),
      ...
      (24,mtef_visitor_source|mtef_team_3,af_override_all,aif_start_alarmed,1,[itm_practice_bow,itm_practice_arrows,itm_practice_arrows_back,itm_practice_horse,itm_arena_tunic_yellow, itm_gold_tourney_helmet]),
      ...
      (28,mtef_visitor_source|mtef_team_3,af_override_all,aif_start_alarmed,1,[itm_practice_bow,itm_practice_arrows,itm_practice_arrows_back,itm_practice_dagger, itm_arena_tunic_yellow, itm_gold_tourney_helmet]),
...
#32
      ...
      (36, mtef_visitor_source|mtef_team_1,af_override_all,aif_start_alarmed,1,[itm_practice_bow,itm_practice_arrows,itm_practice_arrows_back, itm_practice_dagger]),
...
#40-49 not used yet
      ...
      (24,mtef_visitor_source|mtef_team_3,af_override_all,aif_start_alarmed,1,[itm_practice_bow,itm_practice_arrows,itm_practice_arrows_back,itm_practice_dagger, itm_arena_tunic_yellow, itm_gold_tourney_helmet]),
...
##       [(tutorial_box,"str_tutorial_enter_mounted", "str_tutorial"), (val_add,"$tutorial_enter_rider", 1)]),
##
##
