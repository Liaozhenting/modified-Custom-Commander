...
## CC
  ...
  #("music_old_5", "requiem.mp3",        mtf_sit_town|mtf_sit_travel|mtf_module_track, mtf_sit_tavern|mtf_sit_night),
  #("music_old_6", "silentintruder.mp3", mtf_sit_town|mtf_sit_travel|mtf_module_track, mtf_sit_tavern|mtf_sit_night),
  #("music_old_7", "thegreathall.mp3",   mtf_sit_town|mtf_sit_travel|mtf_module_track, mtf_sit_tavern),
  #("music_old_8", "thepilgrimage.mp3",  mtf_sit_town|mtf_sit_travel|mtf_module_track, mtf_sit_tavern|mtf_sit_night),
## CC
