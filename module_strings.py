...
## CC
  ("battlefield_small", "a small battlefield"),
  ("battlefield_normal", "a normal battlefield"),  
  ("battlefield_large", "a large battlefield"),
  ("battlefield_extra_large", "an extra large battlefield"),
  ...
  ("hint_6", "You can order your soldiers to move to a spot by pressing and holding down F1 key."),
  ("hint_7", "Horses and men move less quickly in rainy weather."),
  ("hint_8", "You can wait on the world map by holding down the space bar."),
  ("hint_9", "You can recruit new men to your party in taverns."),
  ("hint_10", "You can give orders to your party while in battle."),
  ("hint_11", "A party with high morale moves more quickly while travelling on the map."),
  ("hint_12", "Wounded party members will heal faster while resting in taverns."),
  ("hint_13", "To quickly buy and sell items in inventory window, hold down control key while you left click."),
  ("hint_14", "You can press Backspace key during battle to bring the command interface."),
  ("hint_15", "You will pay half wages to your troops while you are staying in a town or castle. Similarly, you will pay half wages to troops you garrison in a castle."),
